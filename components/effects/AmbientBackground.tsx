...
export function AmbientBackground() {
  return (
    <div aria-hidden className="pointer-events-none fixed inset-0 z-0">
      ...
      <div className="absolute inset-0 grid-bg opacity-[0.35] [mask-image:radial-gradient(ellipse_at_center,black_20%,transparent_75%)]" />

      <div
        className="absolute -left-32 top-[-8%] h-[28rem] w-[28rem] rounded-full blur-[80px]"
        style={{
          background:
      ...
      />
      <div
        className="absolute right-[-8%] top-[28%] h-[24rem] w-[24rem] rounded-full blur-[80px]"
        style={{
          background:
      ...
      />
      <div
        className="absolute bottom-[-8%] left-[32%] h-[22rem] w-[22rem] rounded-full blur-[72px]"
        style={{
          background:
