...
export function OacBenefits() {
  return (
    <section id="benefits" className="relative overflow-hidden py-32 sm:py-40">
      <div
        aria-hidden
        className="pointer-events-none absolute left-1/2 top-0 h-[28rem] w-[40rem] -translate-x-1/2 rounded-full bg-[radial-gradient(circle,rgba(168,85,247,0.22),rgba(34,211,238,0.12),transparent_65%)] blur-3xl"
      />
      ...
      <div className="container relative z-10">
        <div className="mx-auto flex max-w-3xl flex-col items-center text-center">
          <motion.span
            ...
            className="mb-6 inline-flex items-center gap-2 rounded-full border border-accent-cyan/25 bg-accent-cyan/[0.07] px-4 py-1.5 text-xs font-medium uppercase tracking-[0.28em] text-accent-cyan shadow-[0_0_30px_-10px_rgba(34,211,238,0.7)]"
          >
            <FiGift size={12} />
          ...
          <motion.div
            ...
            className="mt-8 inline-flex items-center gap-3 rounded-full border border-white/10 bg-white/[0.04] px-5 py-2.5 text-sm text-white/70 backdrop-blur"
          >
            <span className="rounded-full bg-accent-gradient px-2.5 py-0.5 text-[10px] font-bold uppercase tracking-[0.18em] text-white shadow-glow animate-pulse-glow">
              5× Free
            </span>
          ...
          {BENEFITS.map((benefit, i) => {
            ...
            return (
              <motion.article
                ...
                whileHover={{ y: -6 }}
                className={cn(
                  "card-shine glow-border group flex flex-col overflow-hidden rounded-[1.75rem] border border-white/10 bg-[#0b0f16] transition-all duration-500 hover:border-accent-cyan/40 hover:shadow-glow",
                  benefit.span,
              ...
              >
                <div className="flex items-start justify-between gap-3 px-5 pt-5 sm:px-6 sm:pt-6">
                  <span
                    className={cn(
                      "grid place-items-center rounded-2xl border border-white/10 bg-gradient-to-br from-accent-cyan/25 to-accent-purple/10 text-accent-cyan transition-transform duration-500 group-hover:scale-110 group-hover:rotate-3",
                      featured ? "h-14 w-14" : "h-11 w-11"
                    )}
                  >
                    <Icon size={featured ? 24 : 18} />
                  </span>
                  <span className="rounded-full border border-accent-cyan/30 bg-accent-cyan/10 px-2.5 py-1 text-[10px] font-bold uppercase tracking-[0.22em] text-accent-cyan transition-all duration-500 group-hover:bg-accent-cyan/20 group-hover:shadow-glow">
                    Free
                  </span>
                </div>
                ...
                >
                  <div
                    className={cn(
                      ...
                      featured
                        ? "aspect-[16/11] h-full min-h-[200px] md:aspect-auto md:min-h-[220px]"
                        : "aspect-[16/10]"
                    )}
                  >
                    <MediaImage
